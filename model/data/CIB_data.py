...
class ImageList_CIB(object):
    ...
    def __init__(self, data_path, image_list, transform, train=False, transform_gan=None):
...
def get_data_CIB(config):
    ...
    train_dataset = ImageList_CIB(config["data_path"],
                                    ...
                                    transform=train_transform, train=True, transform_gan=test_transform)
