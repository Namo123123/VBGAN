...
class Data:
    ...
    def get_loaders(self, batch_size, num_workers, shuffle_train=False,
                    get_test=True):
        train_dataset = MyTrainDataset(self.X_train, self.Y_train, self.train_transforms, self.test_transforms)
        ...
        database_loader = DataLoader(dataset=database_dataset, batch_size=256,
                                                    shuffle=False,
                                                    num_workers=num_workers)
...
class MyTrainDataset(Dataset):
    def __init__(self,data,labels, transform, transform_gan):
        self.data = data
        self.labels = labels
    ...
    def __getitem__(self, index):
        ...
        return (imgi, imgj, self.transform_gan(pilImg))
